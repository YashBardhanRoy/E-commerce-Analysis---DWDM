...
-- ----------------------------------------------------------------------------
-- 2. Dimension Tables (Snowflake Schema)
-- ----------------------------------------------------------------------------
...
-- Customer Dimension (references dim_location)
...
-- Product Dimension (references dim_category and dim_brand)
...
-- Create performance indices on Foreign Keys
